...
export default function Main() {
    ...
    return (
        <div className="w-full flex gap-8 max-2xl:flex-wrap">
                    ...
                    {server && (
                        <div className="w-full card bg-base-200 border-2 border-base-100 shadow-md p-4 mb-2">
                            ...
                            <select className="select w-full max-w-xs mb-3">
                                ...
                                <option>Анархия</option>
                                <option>Гриферский</option>
                                <option>Выживание</option>
                                <option>Мини-игры</option>
                                <option>Прокси</option>
                            </select>
                            <h2 className="text-2xl font-medium mb-3">Описание</h2>
                            <textarea className="textarea textarea-bordered" placeholder="Укажите максимально подробное описание, детали можно обговорить с менеджером в специальном чате"></textarea>
                        </div>
                    )}
                    {plugin && (
                        <div className="w-full card bg-base-200 border-2 border-base-100 shadow-md p-4 mb-2">
                            ...
                            <h2 className="text-2xl font-medium mb-3">Описание</h2>
                            <textarea className="textarea textarea-bordered mb-1" placeholder="Укажите максимально подробное описание, детали можно обговорить с менеджером в специальном чате"></textarea>
            ...
            <div className="2xl:w-1/3 w-full card bg-base-200 border-2 border-base-100 shadow-md p-6">
                ...
                <input type="text" className="input input-bordered w-full mb-5" placeholder="example@mail.ru" />
                <h1 className="text-2xl font-bold mb-5">Цена: ~{price}₽</h1>
                <button className="btn btn-primary w-full">Создать заявку</button>
            </div>
        </div>
    )
}